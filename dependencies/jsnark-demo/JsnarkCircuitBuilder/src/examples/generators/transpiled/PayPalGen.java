...
public class PayPalGen extends CircuitGenerator {
    private Wire[] HS;
    ...
    public PayPalGen(String circuitName) {
	super(circuitName);
    }
	...
	Wire compResult = new LTFloatThresholdComparatorGadget(floatString, floatStringLen, dotIdx,
...
//        String ciphertextStr = "e299486297f0c3a99796fbae87eb1cda0d867b9ed7eff0505fb2cb9dd915954f1a0a325a6b334aa9b44c05e430bb51e0470a8a0e9370e7d81319ee488f6b8108";
	...
	PayPalGen generator = new PayPalGen("PayPalGen_Circuit");
	if (args.length == 0) {
//            // BTC example
//            generator.blockNr = 3;
